...
# This is a 'production like' version with Java components updated to a quite newer version, now having separate vm-properties files.
...
export MUJINA_VERSION=mujina-2.13.0
